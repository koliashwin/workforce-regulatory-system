      ...
      <AppBar position="sticky" elevation={0}
        ...
        <Toolbar sx={{ gap: 2, minHeight: '56px !important', px: { xs: 2, md: 4 } }}>
          ...
          <Box component={Link} to="/"
            ...
            <Box sx={{ width: 30, height: 30, borderRadius: '7px', background: '#f59e0b',
            ...
            <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
              <Typography sx={{ fontFamily: 'Georgia, serif', fontWeight: 700, fontSize: '1rem',
                color: '#fff', lineHeight: 1 }}>Scame</Typography>
              <Typography sx={{ fontSize: '9px', color: '#4a5568', fontFamily: 'monospace',
                letterSpacing: '0.08em' }}>REGULATORY SYSTEM</Typography>
            </Box>
          </Box>
            ...
            {NAV_LINKS.map(({ label, path }) => {
              ...
              return (
                <Button key={path} component={Link} to={path}
                  sx={{ color: active ? '#f59e0b' : '#718096', fontSize: '13px', fontWeight: active ? 600 : 400,
          ...
          <Button component={Link} to="/login" variant="outlined" size="small"
            sx={{ borderColor: '#263142', color: '#a0aec0', fontSize: '12px', ml: 1,
